...
project_slug = 'google_cloud_storage'
...
from connectors.framework.tasks.common import build_image, push_image, prepare_dsx_connect_files, prepare_common_files, \
    bump_patch_version, clean_export, zip_export, prepare_shared_files
